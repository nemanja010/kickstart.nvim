...
--version = false, -- Use `false` for latest commit or a specific tag/commit
--opts = {}, -- Optional: Add any configuration options for mini.files.setup() here
--config = function()
--require('mini.files').setup() -- Call setup function to enable functionality
--end,
--}
